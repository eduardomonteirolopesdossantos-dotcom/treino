const Cartografias = (() => {
  const KEY = 'vestibular_dev_topics_v1';
  ...
  const RELEVANCE_KEY = 'vestibular_dev_relevance_v1';
  let _liveRelevance = (() => {
    try {
  ...
  const DATA_KEY = 'vestibular_dev_carto_data_v1';
  let _liveData = (() => {
    try {
  ...
  // ── Vestibulares CRUD ────────────────────────────────────────────────────
  const VEST_KEY = 'vestibular_dev_vestibulares_v1';
